      ...
      <div>
        ...
        <section id="inicio" className="hero">
          <div className="container">
            <FadeIn delay={300} duration={1200}>
              <h1 className="hero-title">Alisha</h1>
            </FadeIn>
            <SlideUp delay={600} duration={1000}>
              <p className="hero-subtitle">Desarrolladora Web | Programadora | Entusiasta de la Tecnología</p>
            </SlideUp>
            <ScaleIn delay={900} duration={800}>
              <a href="#contacto" className="btn btn-primary">Contáctame</a>
            </ScaleIn>
            
            {/* Spotlight Card para CV */}
        ...
        <section id="sobre-mi" className="section bg-white">
          <div className="container">
            ...
            {/* Bounce Cards Grid */}
            <div className="bounce-cards-grid">
              {/* Card 1: Conocimientos técnicos */}
              ...
              {/* Card 2: Pasión por la tecnología */}
              ...
              <ScrollReveal animation="fadeIn" delay={400}>
                <BounceCard
                  ...
                  description="Gran capacidad de adaptación y aprendizaje rápido, con excelente desempeño en entornos de trabajo dinámicos y cambiantes."
                  color="#ec4899"
              ...
              {/* Card 4: Resolución de problemas */}
              ...
              {/* Card 5: Comunicación y trabajo en equipo */}
            ...
            <div className="skills-container">
              ...
              <ScrollReveal animation="slideUp" delay={200}>
                <div className="skill-card">
                  <SkillBar.Title>Lenguajes de Programación</SkillBar.Title>
                  <SkillBar.Container>
              ...
              <ScrollReveal animation="slideUp" delay={400}>
                <div className="skill-card">
                  <SkillBar.Title>Habilidades Técnicas</SkillBar.Title>
                  <SkillBar.Container>
              ...
              <ScrollReveal animation="slideUp" delay={600}>
                <div className="skill-card">
                  <SkillBar.Title>Habilidades Blandas</SkillBar.Title>
                  <SkillBar.Container>
        ...
        {/* Proyectos Section */}
        <section id="proyectos" className="section bg-white">
          <div className="container">
            <ScrollReveal animation="slideUp">
        ...
        {/* Dock para navegación estilo macOS */}
        <Dock>
          <Dock.Item 
            id="inicio" 
            label="Inicio" 
